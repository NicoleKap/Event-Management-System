...
//          	
		...
		eventServices.addEvent(new Event("Christmas Bazaar","Christmas Event","You can either sell objects or buy objects for charity","Athens",500,"Friday","December","2025",5,30,"5:30",org1,"Pending"));
		eventServices.addEvent(new Event("Cinema Festival","Cinema History","Come and enjoy movies of all time","Athens",500,"Thursday","May","2025",5,30,"5:30",org1,"Pending"));
		...
		eventServices.addEvent(new Event("Choir Festival","Greek cinema","Choirs of Thessaloniki come together to present covers of songs from the Greek cinema","Thessaloniki",500,"Friday","August","2025",19,30,"3 hours",org1,"Pending"));
